...
user-invocable: true
argument-hint: '[instructions] [--max-cycles N] [--timeout MINUTES] [--verbosity minimal|medium|verbose] [--branch BRANCH] [--fresh] [--auto-fix-workflow] [--new-cipe-timeout MINUTES] [--poll-timeout SECONDS]'
allowed-tools:
  - Bash
  - Read
  - Task
  - mcp__plugin_nx_nx-mcp__ci_information
  - mcp__plugin_nx_nx-mcp__ci_poll
